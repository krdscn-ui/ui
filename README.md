...
[**문서 & 컴포넌트 카탈로그**](https://krdscn-ui.js.org/) · [설치 가이드](https://krdscn-ui.js.org/docs/installation/) · [레지스트리](https://krdscn-ui.js.org/docs/registry/)
...
npx shadcn@latest add https://krdscn-ui.js.org/r/krds-all.json
```
...
```bash
# 개별 컴포넌트
npx shadcn@latest add https://krdscn-ui.js.org/r/button.json

# KRDS 디자인 토큰(테마)만
npx shadcn@latest add https://krdscn-ui.js.org/r/krds-theme.json
```

설치 가능한 전체 목록과 각 컴포넌트의 예제·Props는 [문서 사이트](https://krdscn-ui.js.org/docs/components/)에서 확인하세요.
